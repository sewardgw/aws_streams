...
This is a sample template for updateStreamExtendedDestination - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name updatestreamextendeddestination \
...
aws cloudformation describe-stacks \
    --stack-name updatestreamextendeddestination --query 'Stacks[].Outputs'
```
